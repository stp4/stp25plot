...
#     likert.red.green =  likert_col(n = n, name = "RdGn", middle = middle),
#     likert.red.blue = likert_col(n = n, name = "RdBl", middle = middle),
#     likert.green.red = likert_col(n = n, name = "GnRd", middle = middle ),
#     likert.blue.red = likert_col(n = n, name = "BuRd", middle = middle ),
#     likert.bw = likert_col(n = n, name = "Bw", middle = middle),
#     
...
# 
# 
# # colorblind.palette <- rgb(
# #   red = c(230, 86, 0, 240, 0, 213, 204),
