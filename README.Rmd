...
Die Link-Plots habe ich in ein separates Paket ausgelagert. Dort sind auch die Funktionen zur Erstellung der Tabellen enthalten.
...
```{r cowplot-0, fig.height=5, fig.width= 8, message=FALSE}
library(ggplot2)
library(grid)
library(gridExtra)
library(cowplot)
...
Die Effectplots habe ich aus dem Package 'effects' übernommen, jedoch die Übergabe der Attribute angepasst, um die Formatierung zu vereinfachen.
